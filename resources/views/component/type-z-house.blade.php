            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    <div data-aos="zoom-in" class="pb-40 col-lg-6">
                        ...
                        <div class="pb-40 type-content content">
                            <p class="">
                                Terinspirasi oleh gaya hidup generasi Z dan junior milenial, Z house mengutamakan kenyamanan, simplicity, low maintanance.    </p>
                            <div class="table-content">
                                <table class="table type-table">
                                    ...
                                    <tr>
                                        <td>Luas Bangunan</td>
                                        <td>:</td>
                                        <td>- m<sup>2</sup>&nbsp dan &nbsp-m<sup>2</sup></td>
                                    </tr>
                                    </tbody>
                                </table>
                    ...
                    <div data-aos="zoom-in" class="col-lg-6">
                        <div id="carouselIdAsri" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item type active" style="background-image: url({{asset('libs/carousel/z-house/1.jpg')}})">

                                </div>
                                <div class="carousel-item type" style="background-image: url({{asset('libs/carousel/z-house/2.jpg')}})">

                                </div>
                                <div class="carousel-item type" style="background-image: url({{asset('libs/carousel/z-house/3.jpg')}})">

                                </div>
                                <div class="carousel-item type" style="background-image: url({{asset('libs/carousel/z-house/4.jpg')}})">

                                </div>
                                <div class="carousel-item type" style="background-image: url({{asset('libs/carousel/z-house/5.jpg')}})">

                                </div>
                                <div class="carousel-item type" style="background-image: url({{asset('libs/carousel/z-house/6.jpg')}})">
                ...
                <div class="row pt-6 mt-6">
                    ...
                    <div class="col-lg-8  pt-6 mt-6" style="text-align: center">
                        <a href="https://wa.me/62818331515?/?text=Halo%20The%20Essential,%20saya%20ingin%20bertanya%20untuk%20tipe%20rumah%20Z%20House." class="btn btn-success btn-lg active" role="button" aria-pressed="true"><i class="fa fa-whatsapp"></i> Hubungi Kami</a>
                    </div>
                    <div class="col-lg-2">
